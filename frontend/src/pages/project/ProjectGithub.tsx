    ...
    return (
        <div className="project-subpage">
            ...
            <div className="project-subpage__empty">
                ...
                <p className="project-subpage__empty-title">Repositório não configurado</p>
                <p className="project-subpage__empty-desc">
                    Conecte um repositório do GitHub para acompanhar commits, branches e pull requests do projeto.
                </p>
            </div>
        </div>
    )
